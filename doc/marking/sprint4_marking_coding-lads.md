...
## Notes
- User Stories: COL-37 Incorrect user story format
- User Stories: COL-65 not estimated
- User Stories: COL-59/60 Missing acceptance criteria
- Tracking on Jira: Git commit messages like "Done for now", "WIP" and "Done" are not acceptable