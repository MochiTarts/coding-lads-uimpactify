...
## User experience: (max 4 marks)
   ...
   User experience mark: 4
   
   
Total mark for phase 1 : 40/42

## Notes:
- Summary
    - Scenarios were a little generic and should creative with some detail.
    - In depth explanation found in article from [handout](https://articles.uie.com/short_form_creative_brief/)
- Process
  - Team organization regarding roles wasn't exactly justified.
- User experience
  - What is the dashboard for social organizations to find trained people to recruit?
  - Side Note: Security won't be graded and not expected but it is a good practise to make users enter password twice.
Overall very good work! Good luck!